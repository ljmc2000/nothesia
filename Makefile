#############################################################################
# Makefile for building: nothesia
# Generated by qmake (3.1) (Qt 5.15.2)
# Project:  nothesia.pro
# Template: app
# Command: /usr/bin/qmake -o Makefile nothesia.pro
#############################################################################
...
CFLAGS        = -pipe -O2 -march=znver1 -Wall -Wextra -D_REENTRANT -fPIC $(DEFINES)
CXXFLAGS      = -pipe -O2 -march=znver1 -std=gnu++11 -Wall -Wextra -D_REENTRANT -fPIC $(DEFINES)
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = nothesia1.0.0
DISTDIR = /home/pi/workbench/nothesia/.tmp/nothesia1.0.0
LINK          = g++
LFLAGS        = -Wl,-O1
...
DIST          = /usr/lib/qt/mkspecs/features/spec_pre.prf \
		...
		nothesia.pro mainwindow.h main.cpp \
		mainwindow.cpp
QMAKE_TARGET  = nothesia
DESTDIR       = 
TARGET        = nothesia
...
nothesia: ui_mainwindow.h $(OBJECTS)  
	$(LINK) $(LFLAGS) -o $(TARGET) $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: nothesia.pro /usr/lib/qt/mkspecs/linux-g++/qmake.conf /usr/lib/qt/mkspecs/features/spec_pre.prf \
		/usr/lib/qt/mkspecs/common/unix.conf \
		/usr/lib/qt/mkspecs/common/linux.conf \
		/usr/lib/qt/mkspecs/common/sanitize.conf \
		/usr/lib/qt/mkspecs/common/gcc-base.conf \
...
moc_predefs.h: /usr/lib/qt/mkspecs/features/data/dummy.cpp
	g++ -pipe -O2 -march=znver1 -std=gnu++11 -Wall -Wextra -dM -E -o moc_predefs.h /usr/lib/qt/mkspecs/features/data/dummy.cpp
...
moc_mainwindow.cpp: mainwindow.h \
		moc_predefs.h \
		/usr/bin/moc
	/usr/bin/moc $(DEFINES) --include /home/pi/workbench/nothesia/moc_predefs.h -I/usr/lib/qt/mkspecs/linux-g++ -I/home/pi/workbench/nothesia -I/usr/include/qt -I/usr/include/qt/QtWidgets -I/usr/include/qt/QtGui -I/usr/include/qt/QtCore -I/home/pi/.local/include -I/usr/include/c++/10.2.0 -I/usr/include/c++/10.2.0/x86_64-pc-linux-gnu -I/usr/include/c++/10.2.0/backward -I/usr/lib/gcc/x86_64-pc-linux-gnu/10.2.0/include -I/usr/local/include -I/usr/lib/gcc/x86_64-pc-linux-gnu/10.2.0/include-fixed -I/usr/include mainwindow.h -o moc_mainwindow.cpp
...
install_target: first FORCE
	@test -d $(INSTALL_ROOT)/opt/nothesia/bin || mkdir -p $(INSTALL_ROOT)/opt/nothesia/bin
	$(QINSTALL_PROGRAM) $(QMAKE_TARGET) $(INSTALL_ROOT)/opt/nothesia/bin/$(QMAKE_TARGET)
	-$(STRIP) $(INSTALL_ROOT)/opt/nothesia/bin/$(QMAKE_TARGET)

uninstall_target: FORCE
	-$(DEL_FILE) $(INSTALL_ROOT)/opt/nothesia/bin/$(QMAKE_TARGET)
	-$(DEL_DIR) $(INSTALL_ROOT)/opt/nothesia/bin/ 
